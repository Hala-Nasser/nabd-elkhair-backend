...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header form-group row">تسجيل</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary" style="background-color: #10B1B1; border-color: #10B1B1;">
                                    تسجيل
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                            <a class="nav-link" href="{{ route('login') }}" style="color: #10B1B1; padding: 0.5rem 0rem; display: inline-block;">لديك حساب؟</a>
                            </div>
                        </div>
                        @endif

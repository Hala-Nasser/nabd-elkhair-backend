    ...
    <section class="content">
      ...
      <div class="card" style="margin-right: 10px; margin-left: 10px">
        <div class="card-header">
          <h3 class="card-title"  style="color: black;">شاشة الترحيب الثانية</h3>
        </div>
        <!-- form start -->
        <!-- form start -->
        <form method="post" action="{{ URL('donationtype/store') }}" enctype="multipart/form-data">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              <label for="exampleInputFile">العنوان</label>
              <div>
                  <input type="text" class="form-control" placeholder="أدخل العنوان" name="title" style="width:100%; height:40px; margin-left:15px; margin-right:5px; display:block; padding-right: 10px;">
              </div>
            </div>

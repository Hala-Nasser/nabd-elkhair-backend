...
<li class="nav-item">
          ...
          <i class="fas fa-search" style="color:#000; margin-right: 10px;"></i>
        </a>
        <div class="navbar-search-block">

          <form class="form-inline" action="{{URL('store/rate/search')}}" method="get" role="search">
          	@csrf
								...
								<div class="small-box bg-info">
									...
									<a  class="small-box-footer">
										...
										<div class="rating">
											...
											@else
											<span style="color: #fff; margin-left:10px">{{ $store->rate_num }} rating</span>
											@endif

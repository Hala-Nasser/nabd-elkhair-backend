        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter name" name="name"
                    value="{{ $charity->email }}" style="pointer-events: none;">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group" style=" border: 1px solid #ced4da; border-radius: 0.25rem; padding-right:10px; padding-top: 5px">
